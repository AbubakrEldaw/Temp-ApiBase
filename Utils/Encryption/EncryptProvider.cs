...
using System.IO;
using APIBase.Utils.Encryption.Shared;
using APIBase.Utils.Encryption.Extensions;
using APIBase.Utils.Encryption.Internal;
using APIBase.Utils.Encryption.Extensions.Internal;
using System.Net.Http.Headers;

namespace APIBase.Utils.Encryption
{
    public class EncryptProvider
    {
        ...
        */
        ...
        public static string AESDecryptNet6(string data, string key)
        {
            Check.Argument.IsNotEmpty(data, nameof(data));
            Check.Argument.IsNotEmpty(key, nameof(key));
            Check.Argument.IsNotOutOfRange(key.Length, 32, 32, nameof(key));
